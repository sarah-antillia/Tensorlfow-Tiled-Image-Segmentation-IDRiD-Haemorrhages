...
class TiledImageMaskDatasetGenerator:
  ...
  def generate(self, input_images_dir, input_masks_dir, 
    ...
    num_files       = num_image_files
    # This is the just case.
    if num_mask_files < num_image_files:
      num_files = num_mask_files
    ...
    for i in range(num_files):
      ...
      name       = basename.replace("_HE.tif", ".jpg")

      image_file =  os.path.join(input_images_dir, name)   
      index += 1      
...
if __name__ == "__main__":
  try:
    ...
    input_masks_dir  = "./2. All Segmentation Groundtruths/a. Training Set/2. Haemorrhages/"

    output_images_dir = "./Tiled-IDRiD-Haemorrhages-master/images/"
    output_masks_dir  = "./Tiled-IDRiD-Haemorrhages-master/masks/"
